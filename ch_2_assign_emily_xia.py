...
while True:  
	...
	#adding a team	
		...
		print("\nAdded " + str(team_dictionary[number][number])) 
	...
	#searching for a team
		search_team = int(input("What is the number of the team you want to search for? \n"))
		if search_team in team_dictionary == True:
			print("Yes," +search_team "is in the team dictionary")
		if search_team in team_dictionary == False:
			print("I'm sorry, but" +search_team "is not in the team dictionary")
